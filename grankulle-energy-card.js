...
class GrankulleEnergyCard extends HTMLElement {
  ...
  _updateFlow(soc, battPower, battState, froPower) {
    ...
    const battChargeD = 'M 335 108 C 335 96, 335 88, 335 74';
    const battDischargeD = 'M 335 74 C 335 88, 335 96, 335 108';
