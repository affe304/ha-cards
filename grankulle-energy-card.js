...
class GrankulleEnergyCard extends HTMLElement {
  ...
  _updateFlow(soc, battPower, battState, froPower) {
    ...
    const battChargeD = 'M 350 140 C 350 133, 350 127, 350 120';
    const battDischargeD = 'M 350 120 C 350 127, 350 133, 350 140';
    ...
    const gridInImportD = 'M 350 270 C 350 263, 350 257, 350 250';
    const gridInExportD = 'M 350 250 C 350 257, 350 263, 350 270';
    const gridOutImportD = 'M 470 165 C 600 120, 680 80, 720 65';
    const gridOutExportD = 'M 720 65 C 680 80, 600 120, 470 165';
    ...
    setEdge('fv-path-gridout', 'fv-dot-gridout', 'fv-motion-gridout', importing ? gridOutImportD : gridOutExportD, Math.abs(gridSum) > 20);
