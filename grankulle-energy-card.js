...
class GrankulleEnergyCard extends HTMLElement {
  ...
  _buildDom() {
    ...
    this.shadowRoot.addEventListener('click', (ev) => {
      ...
      if (action === 'tado-temp-up') this._callClimateTempStep(0.5);
      if (action === 'tado-temp-down') this._callClimateTempStep(-0.5);
    });
  ...
  _update() {
    ...
    if (tadoState) {
      ...
      this._set('c-tado-target', isNaN(targetTemp) ? '\u2013' : targetTemp.toFixed(1));
