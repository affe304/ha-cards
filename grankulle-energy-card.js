...
class GrankulleEnergyCard extends HTMLElement {
  ...
  _buildDom() {
    ...
    this.shadowRoot.addEventListener('click', (ev) => {
      ...
      if (action === 'ev1f-force-on') this._call('input_boolean', 'turn_on', 'ev_1fas_force');
      if (action === 'ev1f-force-off') this._call('input_boolean', 'turn_off', 'ev_1fas_force');
    });
  ...
  _update() {
    ...
    if (ev1fasState) {
      ...
      const forceState = this._val('ev_1fas_force');
      const onBtn = this.shadowRoot.getElementById('ev1f-force-on-btn');
      const offBtn = this.shadowRoot.getElementById('ev1f-force-off-btn');
      if (onBtn) onBtn.classList.toggle('active', forceState === 'on');
      if (offBtn) offBtn.classList.toggle('active', forceState !== 'on');
    }
