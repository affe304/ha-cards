...
class GrankulleEnergyCard extends HTMLElement {
  ...
  _updateFlow(soc, battPower, battState, froPower) {
    ...
    const battChargeD = 'M 350 110 C 350 96, 350 82, 350 66';
    const battDischargeD = 'M 350 66 C 350 82, 350 96, 350 110';
    ...
    const gridInImportD = 'M 350 214 C 350 200, 350 190, 350 176';
    const gridInExportD = 'M 350 176 C 350 190, 350 200, 350 214';
    const gridOutImportD = 'M 470 125 C 600 90, 680 55, 720 37';
    const gridOutExportD = 'M 720 37 C 680 55, 600 90, 470 125';
